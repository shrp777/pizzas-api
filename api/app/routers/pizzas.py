...
@router.get("/pizzas", response_model=List[Pizza], status_code=200)
...
@router.get("/pizzas/{pizza_id}", response_model=Pizza, status_code=200)
...
@router.put("/pizzas/{pizza_id}", response_model=Pizza, status_code=200)
